...
public interface EmployeeService {
    ...
    Flux<EmployeeEntity> getEmployeesByBuilding(String buildingName);
    ...
    Flux<EmployeeDTO> getEmployeesDTOByBuilding(String buildingName);
    ...
    Flux<EmployeeDTO> requestGetEmployeesDTOByBuilding(String buildingName);
